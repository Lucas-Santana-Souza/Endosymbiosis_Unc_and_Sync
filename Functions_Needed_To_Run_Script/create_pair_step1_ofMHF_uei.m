% 2023.06.28 - Author: Lucas Santana Souza
...
function endomodel= create_pair_step1_ofMHF_uei(ehmodel1 ,ehmodel2 ,ne ,ni, nu)
...
% [ S_int ] | [ S_ext2int ] [=] [0]                                           -> REGION b4 
% [   0   ] | [   S_int   ] [=] [0]                                           -> REGION b5  
% [   0   ] | [     1     ] [>] [0]                                           -> REGION for constrain in the growth rate
...
%endomodel.rhs(end)=0;   %This changes depending on who is max second or if the (Host's growth) = (Guest's growth)

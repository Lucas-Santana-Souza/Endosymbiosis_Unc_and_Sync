...
%% Structure of the holobiont matrix (created in the 'create_pair_step2_ofMHF_uei_Ng.m' function):
%   HOST          GUEST
...
function endomodel = create_pair_step2_ofMHF_uei_Ng (ehmodel1 ,ehmodel2 ,ne ,ni, nu ,result_pairij_step1_ofMHF_firstMi ,Ng)
